<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Site1.master" AutoEventWireup="true" CodeFile="Vehicles.aspx.cs" Inherits="Customer_Vehicles" %>
    ...
    <tr>
        <td>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT * FROM [VehicleMaster] WHERE ([Status] = @Status)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="InStock" Name="Status" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </td>
    </tr>
