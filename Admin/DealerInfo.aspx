<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.master" AutoEventWireup="true" CodeFile="DealerInfo.aspx.cs" Inherits="Admin_DealerInfo" %>
        ...
        <table bgcolor="#FFCCFF">
            <tr>
                <td colspan="2" style="background-color: #CC0066">
                    <strong><span class="style7" style="background-color: #CC0066">Add New Dealer
                    </span></strong>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                        ControlToValidate="PersonTextBox" ErrorMessage="(only characters and spaces)" 
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                        ControlToValidate="ContactNoTextBox" ErrorMessage="(Enter 10 digit mobile no)" 
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="AddressTextBox" runat="server" Height="61px" TextMode="MultiLine" 
                        Width="394px" CssClass="txt" ontextchanged="AddressTextBox_TextChanged"></asp:TextBox>
            ...
            <tr>
                <td class="style3">
                    &nbsp;</td>
                <td>
                    <asp:Button ID="Button1" runat="server" Text="Save Dealer Info" 
